...
extension DKMFormatterWriterTests {
    ...
    func writeScore_forcesSectionForClipMode() throws {
        var writer = DKMFormatter.Writer(score: DKMScore(commands: [.clipMode(channel: .right, name: "FirstClip"),
    ...
    func writeScore_forcesSectionForVocodeMode() throws {
        let mode = DKMCommand.vocodeMode(channel: .right,
                                         name: "ExtSound",
                                         clipRate: 1.0,
                                         maxHarm: 0,
                                         slope: 0.0,
    ...
    func writeScore_multipleCommands() throws {
        let commands: [DKMCommand] = [.tempoLine(startBeat: 0.0, duration: 1.0, initialTempo: 60.0, finalTempo: 60.0),
