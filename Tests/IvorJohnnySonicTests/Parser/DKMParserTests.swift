...
extension DKMParserTests {
    ...
    func parseCommentBetweenSameCommands() throws {
        ...
        let expected: [DKMCommand] = [.tempoLine(DKMTempoLine(startBeat: 0.0, duration: 1.0, startTempo: 57.0, endTempo: 57.0)),
                                      .comment(" interleaved"),
    ...
    func parseDifferentSections() throws {
        let score = try parseScore("/Tempo\n0.0 1.0 60.0 60.0\n/Pulse\n10.0 B\n")
        let expected: [DKMCommand] = [.tempoLine(DKMTempoLine(startBeat: 0.0, duration: 1.0, startTempo: 60.0, endTempo: 60.0)),
